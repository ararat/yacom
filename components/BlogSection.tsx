...
const BlogSection: React.FC<BlogSectionProps> = ({ posts }) => {
  ...
  return (
    <div className="w-full px-6 sm:px-8 md:px-12 lg:px-24 xl:px-32 pt-20 sm:pt-24 pb-16 text-obs-text" style={{maxWidth:"1920px",marginLeft:"auto",marginRight:"auto"}}>
      {/* Title */}
